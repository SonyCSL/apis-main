				...
				if (resMap.succeeded()) {
					...
					lockMap.putIfAbsent(key, value, resPutIfAbsent -> {
						if (resPutIfAbsent.succeeded()) {
							...
							ErrorExceptionUtil.logAndFail(Error.Category.FRAMEWORK, Error.Extent.LOCAL, Error.Level.ERROR, resPutIfAbsent.cause(), completionHandler);
						}
					});
				} else {
					ErrorExceptionUtil.logAndFail(Error.Category.FRAMEWORK, Error.Extent.LOCAL, Error.Level.ERROR, resMap.cause(), completionHandler);
				}
			});
		} else {
							...
							if (removed) {
								...
								lockMap.get(key, resGet -> {
									if (resGet.succeeded()) {
										...
										ErrorExceptionUtil.logAndFail(Error.Category.FRAMEWORK, Error.Extent.LOCAL, Error.Level.ERROR, resGet.cause(), completionHandler);
									}
								});
							}
						} else {
							ErrorExceptionUtil.logAndFail(Error.Category.FRAMEWORK, Error.Extent.LOCAL, Error.Level.ERROR, resRemoveIfPresent.cause(), completionHandler);
						}
					});
				} else {
					ErrorExceptionUtil.logAndFail(Error.Category.FRAMEWORK, Error.Extent.LOCAL, Error.Level.ERROR, resMap.cause(), completionHandler);
				...
				if (resMap.succeeded()) {
					...
					lockMap.remove(key, resRemove -> {
						if (resRemove.succeeded()) {
							...
							ErrorExceptionUtil.logAndFail(Error.Category.FRAMEWORK, Error.Extent.LOCAL, Error.Level.ERROR, resRemove.cause(), completionHandler);
						}
					});
				} else {
					ErrorExceptionUtil.logAndFail(Error.Category.FRAMEWORK, Error.Extent.LOCAL, Error.Level.ERROR, resMap.cause(), completionHandler);
