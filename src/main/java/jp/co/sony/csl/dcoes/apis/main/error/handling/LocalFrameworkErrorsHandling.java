 ...
 * @author OES Project
 */
public class LocalFrameworkErrorsHandling extends AbstractErrorsHandling {
	 ...
	 */
	public LocalFrameworkErrorsHandling(Vertx vertx, JsonObject policy, JsonArray errors) {
